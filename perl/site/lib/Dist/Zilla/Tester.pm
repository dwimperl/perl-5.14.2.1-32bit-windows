...
{
  $Dist::Zilla::Tester::VERSION = '4.300007';
}
use Moose;
...
{
  $Dist::Zilla::Tester::_Role::VERSION = '4.300007';
}
  use Moose::Role;
...
{
  $Dist::Zilla::Tester::_Builder::VERSION = '4.300007';
}
  use Moose;
  extends 'Dist::Zilla::Dist::Builder';
...
{
  $Dist::Zilla::Tester::_Minter::VERSION = '4.300007';
}
  use Moose;
